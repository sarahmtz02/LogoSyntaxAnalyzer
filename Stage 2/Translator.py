...
class Arc(Void):
    ...
    def eval(self, env, aTurtle):
        radius = int(self.radius.eval(env, aTurtle))
        extent = int(self.extent.eval(env, aTurtle))
...
class Left(Void):
    ...
    def eval(self, env, aTurtle):
        left = int(self.expression.eval(env, aTurtle))
        aTurtle.left(left)
...
class Right(Void):
    ...
    def eval(self, env, aTurtle):
        right = int(self.expression.eval(env, aTurtle))
        aTurtle.right(right)
...
class Backward(Void):
    ...
    def eval(self, env, aTurtle):
        backward = int(self.expression.eval(env, aTurtle))
...
class Forward(Void):
    ...
    def eval(self, env, aTurtle):
        forward = int(self.expression.eval(env, aTurtle))
